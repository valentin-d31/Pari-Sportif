...
<form action="{{route('admin.update', $match)}}" method= "POST">
    ...
    <div class="form-group">
        ...
        name="name" placeholder="Rentrez le nom du match" value="{{old('name') ?? $match->name}}">
        @error('match')
    ...
    <div class="form-group">
        ...
        name="pays" placeholder="Rentrez le nom pays" value="{{old('pays') ?? $match->pays}}">
        @error('pays')
          <div class="invalid-feedback">
              {{$errors->first('pays')}}
          </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('pays') is-invalid @enderror"
        name="duree" placeholder="Rentrez la duree du match" value="{{old('duree') ?? $match->duree}}">
        @error('duree')
          <div class="invalid-feedback">
              {{$errors->first('duree')}}
          </div>
